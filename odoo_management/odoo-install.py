# with root
# try install basics: apt-python, wkhtml, net-tools, etc.
# 	for any version
#		try create version-user
#			try login with version-user
#				try create postgre instance
#				try create python virtual env
#				try create basic dir paths (without repos)
#		!!!		try update repos by version  !!!
#				try create odoo conf (ports postgre and odoo, var/log, etc)
#				try create nginx conf
