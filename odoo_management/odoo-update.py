# for any version with their user
# 	for any org
#		for any repo
#			try create dir 
#				cd dir && git clone
#				TextLog "New Repo added in git path"
#			catch
#				try cd dir && git pull
#					TextLog "Existing Repo was updated in git path"
#				catch
#					TextLog "Existing Repo wasn't updated in git path"
#			for any module in repo
#				try create symlink in addons
#					TextLog "Module already exists in addons path"
#				catch
#				 	TextLog "New Module was added to addons path"				
